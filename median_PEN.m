...
file1={'8_10_21 m1\', '8_10_21 m2 session 1\', '06-23-21 RECUT 2.0 session 1 m1\','8_12_21 m1\' };
str=string(file1);
MainDirectory = 'C:\Users\Administrator\MATLAB\Projects\Mouse EEG git\Data\PEN';
...
baseline = dir([folder '1 min nb.mat']); % or baseline 1 or baseline 2 depending on trials 
...
if folder == "C:\Users\Administrator\MATLAB\Projects\Mouse EEG git\Data\PEN\06-23-21 RECUT 2.0 session 1 m1\"
V1L=set_channels(3);S1L=set_channels(4);S1R=set_channels(2);V1R=set_channels(1);lightstim=set_channels(5);
end

if folder == "C:\Users\Administrator\MATLAB\Projects\Mouse EEG git\Data\PEN\06-24-21 RECUT session 2 m2\" 
V1L=set_channels(3);S1L=set_channels(4);S1R=set_channels(2);V1R=set_channels(1);lightstim=set_channels(5);
end

if folder == "C:\Users\Administrator\MATLAB\Projects\Mouse EEG git\Data\PEN\8_10_21 m1\" 
V1L=set_channels(4);S1L=set_channels(3);S1R=set_channels(2);V1R=set_channels(1);lightstim=set_channels(5);
end 

if folder == "C:\Users\Administrator\MATLAB\Projects\Mouse EEG git\Data\PEN\8_10_21 m2 session 1\"
V1L=set_channels(3);S1L=set_channels(4);S1R=set_channels(2);V1R=set_channels(1);lightstim=set_channels(5);
end 

if folder == "C:\Users\Administrator\MATLAB\Projects\Mouse EEG git\Data\PEN\8_12_21 m1\" 
V1L=set_channels(4);S1L=set_channels(3);S1R=set_channels(1);V1R=set_channels(2);lightstim=set_channels(5);
end

if folder == "C:\Users\Administrator\MATLAB\Projects\Mouse EEG git\Data\PEN\8_12_21 m2\"
V1L=set_channels(3);S1L=set_channels(1);S1R=set_channels(2);V1R=set_channels(4);lightstim=set_channels(5);
end

if folder == "C:\Users\Administrator\MATLAB\Projects\Mouse EEG git\Data\PEN\8_13_21\"
