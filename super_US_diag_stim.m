...
% alldata.V1Ldata=data(datastart(V1L):dataend(V1L)); %could put filter into same line
...
%Filter out noise, commented out and talk to nels about this
...
%     a=a/100*1000;
%    
%     [bb,aa]=butter(3,[3,100]/(fs/2)); 
    [bb,aa]=butter(3,[4,7]/(fs/2));
%     [bb,aa]=butter(3,[8,11]/(fs/2));
    %trying to get the us noise out, 3 to 200
...
% d=stas.(char(names(1))); % no need if we put in the alldata section
